            ...
            case R.id.train_button:
                ...
                if(train_enabled) {
                    ...
                    try {
                        ...
                        Intent sensorService = new Intent(trainActivity.this,SensorListener.class);
                ...
                {
                    Toast.makeText(getApplicationContext(), "Please wait, collecting data.", Toast.LENGTH_SHORT).show();
                }
                break;
